...
IL_0009:
	...
	try
	{
		...
		try
		{
			...
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_mFB50A5ABA450F464BCF08AEB35E14D26BB582C78(__this, L_3, ((*(int32_t*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 19)))), il2cpp_rgctx_method(method->klass->rgctx_data, 56));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
...
IL_0009:
	...
	try
	{
		...
		try
		{
			Hash128_t93367F504B687578F893CDBCD13FB95AC8A87A40 L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_mA7FD9D5C57D1D777C74BECE3613749319B4C2CD3(__this, L_3, ((RuntimeObject*)Castclass((RuntimeObject*)L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 19))), il2cpp_rgctx_method(method->klass->rgctx_data, 56));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
